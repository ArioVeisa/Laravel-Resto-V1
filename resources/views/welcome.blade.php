<x-guest-layout>
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        <section class="pt-4 pb-12 bg-gray-800 my-2">
            <div class="container mx-auto text-center">
                <h2
                    class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 mb-8">
                ...
                <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <div class="p-6 bg-white rounded-lg shadow-lg">
                        <div class="mb-4">
                            <img class="w-16 h-16 rounded-full mx-auto"
                                src="https://cdn.pixabay.com/photo/2021/03/22/01/58/monk-6113501_1280.png"
                                alt="Customer Image">
                        </div>
                        <p class="text-gray-700 italic">"The food here is absolutely amazing! A perfect blend of
                            flavors, and the ambiance is wonderful."</p>
                        <div class="mt-4">
                    ...
                    <div class="p-6 bg-white rounded-lg shadow-lg ">
                        ...
                        <p class="text-gray-700 italic">"Amazing experience! Great service and delicious dishes. Highly
                            recommend trying the chef's special."</p>
                        <div class="mt-4">
                            <p class="font-semibold text-gray-900">Emily Smith</p>
                    ...
                    <div class="p-6 bg-white rounded-lg shadow-lg">
                        <div class="mb-4">
                            <img class="w-16 h-16 rounded-full mx-auto"
                                src="https://cdn.pixabay.com/photo/2017/08/30/07/47/silhouette-2696203_1280.jpg"
                                alt="Customer Image">
                        </div>
                        <p class="text-gray-700 italic">"A wonderful place to dine with friends and family. The
                            atmosphere is cozy and the staff is friendly."</p>
                        <div class="mt-4">
